# AGENTS.md — ricetta di customizzazione per agenti AI

Guida pratica per un assistente AI (Cursor, Claude Code e simili) che deve
**personalizzare questa installazione** di Open E.Hub per uno studio tecnico:
prezzario proprio, cartiglio proprio, branding proprio, eventualmente un tool nuovo.
